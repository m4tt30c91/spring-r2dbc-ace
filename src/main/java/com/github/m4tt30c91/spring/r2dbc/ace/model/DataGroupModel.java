...
/**
 * The interface to be implemented by entities that define grouping association between DataModels
 * 
...
public interface DataGroupModel<B extends DataModel, C extends DataModel> {
    ...
    /**
     * <strong>collecatable</strong> retrieve the collectable class of the grouping association
     * 
    ...
    /**
     * <strong>getCollectables</strong> retriece the list of collectables from the base
     * 
    ...
    /**
     * <strong>setCollectables</strong> set the given collectables to the list of collectables in
     * base
     * 
     * @param base the base

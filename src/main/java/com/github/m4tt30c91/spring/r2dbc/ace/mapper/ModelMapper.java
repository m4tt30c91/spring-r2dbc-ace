...
/**
 * The interface to be implemented in order to define mappers for specific DataModels
 * 
...
public interface ModelMapper<T extends DataModel> {
    ...
    /**
     * <strong>map</strong> perform a mapping between each entry in a row and the DataModel
     * 
     ...
     * <p>
     * If the specific implementation does not require any DataGroupModel, the implementation may
